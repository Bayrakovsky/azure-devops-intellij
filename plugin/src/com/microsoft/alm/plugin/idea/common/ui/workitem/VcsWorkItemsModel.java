                ...
                OperationExecutor.getInstance().submitOperationTask(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (wasBranchCreated) {
                            ...
                            VcsNotifier.getInstance(project).notifyImportantInfo(null, TfPluginBundle.message(wasWorkItemAssociated ? TfPluginBundle.KEY_WIT_ASSOCIATION_SUCCESSFUL_TITLE : TfPluginBundle.KEY_WIT_ASSOCIATION_FAILED_TITLE),
